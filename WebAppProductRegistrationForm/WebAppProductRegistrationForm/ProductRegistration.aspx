...
<body>
    ...
    <div class="col-md-4"><asp:Image runat="server" ID="Image2" ImageUrl="~/Image/P2.jpeg"
    ...
    <table class="auto-style1">
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator runat="server" ControlToValidate="ddlCat" ErrorMessage="Select Category" ForeColor="Red"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
